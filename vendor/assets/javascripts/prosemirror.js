...
},{"../model":36,"../transform":47}],2:[function(require,module,exports){
"use strict";
...
},{"../edit":9,"../model":36,"../schema-table":45,"../transform":47}],3:[function(require,module,exports){
"use strict";
...
},{"../edit":9,"../model":36,"../transform":47,"../util/browser":56,"../util/char":57,"browserkeymap":64}],4:[function(require,module,exports){
"use strict";
...
},{"../util/browser":56,"./selection":15,"browserkeymap":64}],5:[function(require,module,exports){
"use strict";
...
},{"../model":36,"../transform":47,"./dompos":7,"./selection":15}],7:[function(require,module,exports){
"use strict";
...
},{"../util/browser":56,"../util/dom":59,"./dompos":7}],9:[function(require,module,exports){
"use strict";
...
},{"./main":11,"./plugin":13,"./range":14,"./selection":15,"browserkeymap":64}],10:[function(require,module,exports){
"use strict";
...
},{"../model":36,"../util/browser":56,"../util/dom":59,"./capturekeys":4,"./domchange":6,"./selection":15,"browserkeymap":64}],11:[function(require,module,exports){
"use strict";
...
},{"../model":36,"../transform":47,"../util/dom":59,"../util/map":61,"./css":5,"./dompos":7,"./draw":8,"./input":10,"./options":12,"./range":14,"./selection":15,"./transform":16,"./update":17,"subscription":65}],12:[function(require,module,exports){
"use strict";
...
},{"../util/browser":56,"../util/dom":59,"./dompos":7}],16:[function(require,module,exports){
"use strict";
...
},{"../model":36,"../transform":47,"./selection":15}],17:[function(require,module,exports){
"use strict";
...
},{"../commands":3,"../edit":9,"../history":22,"../inputrules":23,"../menu":28,"../schema-basic":44,"./keymap":19,"./menu":20,"./style":21}],19:[function(require,module,exports){
"use strict";
...
exports.buildKeymap = buildKeymap;
},{"../commands":3,"../commands-list":1,"../commands-table":2,"../schema-basic":44,"../schema-table":45,"../util/browser":56,"browserkeymap":64}],20:[function(require,module,exports){
"use strict";
...
exports.buildMenuItems = buildMenuItems;
},{"../commands-list":1,"../commands-table":2,"../menu":28,"../prompt":43,"../schema-basic":44,"../schema-table":45,"../util/obj":62}],21:[function(require,module,exports){
"use strict";
...
},{"../util/dom":59}],22:[function(require,module,exports){
"use strict";
...
var Branch = function () {
  ...
  _createClass(Branch, [{
    ...
    value: function popEvent(doc, preserveItems, upto) {
      ...
      for (;; end--) {
        var next = this.items[end - 1];
        if (upto && next == upto) break;
        if (!next.map) return null;
        if (next.selection && !upto) {
          --end;break;
        }
      }

      var remap = preserveItems ? this.remapping(end, this.items.length) : null;
      var transform = new Transform(doc);
      var selection = void 0,
          ids = [];

      for (var i = this.items.length - 1; i >= end; i--) {
      ...
      for (var i = from; i < to; i++) {
        ...
        if (item.mirror != null) {
          for (var j = i - 1; j >= from; j--) {
            if (this.items[j].id == item.mirror) {
    ...
    value: function rebased(newMaps, rebasedTransform, positions) {
      ...
      if (positions.length) {
        var inverted = this.items.slice(start).reverse().map(function (i) {
          return i.map.invert();
        });
        var remap = new Remapping(inverted.concat(newMaps), inverted.length);
    ...
    value: function compress(upto) {
      ...
      var remap = this.remapping(1, upto);
      var items = [],
          events = 0;
      for (var i = this.items.length - 1; i >= 0; i--) {
        var item = this.items[i];
...
},{"../edit":9,"../transform":47}],23:[function(require,module,exports){
"use strict";
...
},{"../edit":9}],25:[function(require,module,exports){
"use strict";
...
},{"../util/dom":59}],28:[function(require,module,exports){
"use strict";
...
// given editor state.
},{"../util/obj":62,"./menu":29,"./menubar":30,"./tooltipmenu":31}],29:[function(require,module,exports){
"use strict";
...
},{"../commands":3,"../util/dom":59,"../util/obj":62,"./icons":27}],30:[function(require,module,exports){
"use strict";
...
},{"../edit":9,"../util/dom":59,"./menu":29}],31:[function(require,module,exports){
"use strict";
...
},{"../edit":9,"../tooltip":46,"../util/dom":59,"./menu":29}],32:[function(require,module,exports){
"use strict";
...
},{"./fragment":34,"./mark":37}],33:[function(require,module,exports){
"use strict";
...
},{"./diff":33,"./to_dom":42}],35:[function(require,module,exports){
"use strict";
  ...
  new (function (_DOMParseState) {
    ...
    _createClass(_class, [{
      ...
      value: function enter(type, attrs) {
        ...
        if (openLeft == 0) return _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "enter", this).call(this, type, attrs);
...
},{"./fragment":34,"./mark":37}],36:[function(require,module,exports){
"use strict";
...
},{"./content":32,"./fragment":34,"./from_dom":35,"./mark":37,"./node":38,"./replace":39,"./resolvedpos":40,"./schema":41}],37:[function(require,module,exports){
"use strict";
...
Mark.none = [];
},{"../util/comparedeep":58}],38:[function(require,module,exports){
"use strict";
...
},{"../util/comparedeep":58,"./fragment":34,"./mark":37,"./replace":39,"./resolvedpos":40,"./to_dom":42}],39:[function(require,module,exports){
"use strict";
...
},{"../util/error":60,"./fragment":34}],40:[function(require,module,exports){
"use strict";
...
},{"../util/obj":62,"../util/orderedmap":63,"./content":32,"./fragment":34,"./from_dom":35,"./mark":37,"./node":38}],42:[function(require,module,exports){
"use strict";
...
},{"../util/dom":59}],44:[function(require,module,exports){
"use strict";
...
},{"../model":36}],45:[function(require,module,exports){
"use strict";
...
},{"../model":36,"../transform":47,"../util/obj":62}],46:[function(require,module,exports){
"use strict";
...
},{"../util/dom":59}],47:[function(require,module,exports){
"use strict";
...
var Remapping = function () {
  ...
  function Remapping(maps) {
    var mapFrom = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
    var mirror = arguments[2];
  ...
  _createClass(Remapping, [{
    ...
    value: function map(pos, bias) {
      ...
      for (var i = this.mapFrom; i < this.maps.length; i++) {
...
},{"../model":36,"./mark_step":50,"./replace_step":52,"./transform":55}],50:[function(require,module,exports){
"use strict";
...
},{"../model":36,"./step":53}],51:[function(require,module,exports){
"use strict";
...
},{"../model":36,"./replace_step":52,"./transform":55}],52:[function(require,module,exports){
"use strict";
...
},{"../model":36,"./map":48,"./step":53}],53:[function(require,module,exports){
"use strict";
...
},{"../model":36,"./map":48}],54:[function(require,module,exports){
"use strict";
...
},{"../model":36,"./replace_step":52,"./transform":55}],55:[function(require,module,exports){
"use strict";
...
},{"../util/error":60,"./map":48}],56:[function(require,module,exports){
"use strict";
...
},{"./node_modules/prosemirror/dist/edit":9,"./node_modules/prosemirror/dist/example-setup":18,"./node_modules/prosemirror/dist/menu":28,"./node_modules/prosemirror/dist/model":36,"./node_modules/prosemirror/dist/schema-basic":44}]},{},[66]);
